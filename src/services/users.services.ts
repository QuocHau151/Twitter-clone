...
class UsersService {
  ...
  private signVerifyEmailTokenandRefreshToken(user_id: string) {
  ...
  async register(payload: RegisterReqBody) {
    ...
    const [access_token, refresh_token] = await this.signVerifyEmailTokenandRefreshToken(user_id)
